...
tally[,1]=ifelse(tally[,2]==0,Max_n,tally[,1]) #Set column with sample size to Max_n if the stopping rules weren´t reached
colnames(tally)=c("nstop","success", "BF", "HDI")

# stop the clusters
sfStop()

save.image("~/Magister/Rwork/workspace_BF_HDIFullSimSmalleffect")
...
segments(x0 = 0, y0 = 0.85, x1 = 33, y1 = 0.85, lty = 2) # Horizontal dashed line for 85 %
segments(x0 = 33, y0 = 0.85, x1 = 33, y1 = 0, lty = 2) # Vertical dashed line for 85%

segments(x0 = 0, y0 = 0.9, x1 = 38, y1 = 0.9, lty = 2, col = "darkgray" ) # Horizontal dashed line for 90%
segments(x0 = 38, y0 = 0.9, x1 = 38, y1 = 0, lty = 2, col = "darkgray") # Vertical dashed line for 90%

segments(x0 = 0, y0 = 1, x1 = 72, y1 = 1, lty = 2, col = "brown") # Horizontal dashed line for 100 %
segments(x0 = 72, y0 = 1, x1 = 72, y1 = 0, lty = 2, col = "brown") # Vertical dashed line for 100%




#Plot HDI width with tallydf (Figures 5-7)
...
#Plot with Dftally, HDI-0.5 (Figure 5-7)

windows()
par(mar = c(5,5,2,5))
with(Dftally, plot(Dftally$nstop, Dftally$HDI, type="l", col="blue", family = "serif",xlim = c(10,100), ylim = c(0.3,2),
...
plot(Dftally$nstop, Dftally$BF, type = "l", xlim = c(10,100), yaxt = "n",
...
##Plot success-rate with HDI and dashed lines at 100% (Figure 10)

windows()
par(mar = c(5,5,2,5))
with(PropTally, plot(PropTally$nstop, PropTally$propsuccess, type="l", col="darkgreen", family = "serif", cex= 2, 
                     xlim = c(10, 100), yaxt ="n",
                     ylab="Propotion of successful simulations",
                     xlab=expression(paste(italic(n),' = number of participants in each group'))))
...
segments(x0 = 0, y0 = 1, x1 = 72, y1 = 1, lty = 2) # Horizontal dashed line for 100%
segments(x0 = 72, y0 = 1, x1 = 72, y1 = -2, lty = 2) # Vertical dashed line for 100%


par(new = TRUE, mar = c(5,5,2,5) )
plot(Dftally$nstop, Dftally$HDI, type = "l", xlim = c(10, 100), yaxt = "n",
     ylim = c(0.5,2), family = "serif", ylab = "", xlab = "", col = "blue", lty = 1)

axis(side = 4)
mtext("HDI-width", side = 4, line = 3, family = "serif")
legend("topleft", c("Success rate", "HDI-width", "100% Success rate"),
       col = c("darkgreen", "blue", "black"), lty = c(1, 1, 2),  cex = .9, y.intersp = 1.5,bg = "white", text.font = 6)
